...
public class WalletService {
    ...
    /**
     * Creates a wallet service with required repository dependency.
     *
     * @param walletRepository repository used for wallet persistence and lookup
     */
     ...
     * @throws ResourceNotFoundException when no wallet exists for the address
     */
