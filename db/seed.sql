...
-- Users with email, pass, id, etc (All passwords 'password')
...
-- Minting for accounts
    (1, NULL, 'addr_1', 50.000000, NULL , 'TC', 'DEPOSIT', 10.000000, 50.000000, 0.01, 0, CURRENT_TIMESTAMP, 'tx_hash_001', 'PENDING', NULL),
    (2, NULL, 'addr_2', 1.000000, NULL , 'TC', 'DEPOSIT', 10.000000, 10.000000, 0.01, 0, CURRENT_TIMESTAMP, 'tx_hash_002', 'PENDING', NULL),
    (3, NULL, 'addr_3', 35.000000, NULL , 'TC', 'DEPOSIT', 10.000000, 350.000000, 0.01, 0, CURRENT_TIMESTAMP, 'tx_hash_003', 'PENDING', NULL),
    (4, NULL, 'addr_4', 100.000000, NULL , 'TC', 'DEPOSIT', 10.000000, 1000.000000, 0.01, 0, CURRENT_TIMESTAMP, 'tx_hash_004', 'PENDING', NULL),
    (5, NULL, 'addr_5', 1000.000000, NULL , 'TC', 'DEPOSIT', 10.000000, 10000.000000, 0.01, 0, CURRENT_TIMESTAMP, 'tx_hash_005', 'PENDING', NULL),
    (6, NULL, 'addr_6', 62.000000, NULL , 'TC', 'DEPOSIT', 10.000000, 620.000000, 0.01, 0, CURRENT_TIMESTAMP, 'tx_hash_006', 'PENDING', NULL),

-- Confirmed/working transaction
    (7, 'addr_5', 'addr_3', 5.000000, 1 , 'TC', 'TRANSFER', 10.000000, 50.00, 0.01, 1, CURRENT_TIMESTAMP, 'tx_hash_007', 'PENDING', NULL),

-- Pending transaction
    (8, 'addr_5', 'addr_6', 10.000000, 5 , 'TC', 'BUY', 10.000000, 100.000000, 0.01, 1, CURRENT_TIMESTAMP, 'tx_hash_008', 'PENDING', NULL),

-- Failed/insufficient balance transaction
    (9, 'addr_1', 'addr_2', 10.000000, 1 , 'TC', 'BUY', 10.000000, 100.000000, 0.01, 1, CURRENT_TIMESTAMP, 'tx_hash_009', 'PENDING', NULL);

-- Staking events
-- Shows available vs staked vs total in balance endpoint
INSERT INTO staking_events (wallet_address, event_type, amount, created_at)
VALUES
    ('addr_5', 'STAKE',   10.00000000, NOW() - INTERVAL 1 DAY),
    ('addr_5', 'UNSTAKE',  3.00000000, NOW());
